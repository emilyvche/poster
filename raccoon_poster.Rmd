---
title: Exploratory analysis of *Campylobacter* in an Ontario raccoon population with Whole Genome Sequencing 
author:
  - name: Emily V. Che
    affil: 1, 2
...
- Previous analyses of the raccoon dataset based on presence/absence of 40 accessory genes with Comparative Genomic Fingerprinting (CGF). 


## Purpose

- Use whole genome sequencing (WGS) data with cgMLST to investigate genetic similarities between *Campylobacter* isolates from a raccoon population. 
...
```{r distance_heatmap, out.width='80%', fig.align='center', fig.cap= 'Heatmap of distance matrix for pairwise comparisons of genomes.'}
...
There are many potential analyses to be conducted on this dataset. A few interesting analyses may be to: 

- What constitutes a different strain, if isolates are obtained from the same animal at the same time and are genetically similar
- Survival time of a strain within a raccoon 
