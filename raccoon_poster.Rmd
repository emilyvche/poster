...
- Core Genome Multilocus Sequence Typing (cgMLST) measures inter-genomic distance based on allelic profiles of *Campylobacter* core genome [@barker2018principles]. 
...
```{r SimvsCluster, out.width= '80%', fig.align= 'center', fig.cap= 'Average Genetic Similarity vs CGF Cluster Identity. Individual bar represents a CGF cluster. Increasing average distance represents increasing genetic disimilarity. CGF cluster was based on a threshold of 0 presence/absence differences of 40 accessory genes. '}
...
```{r SimvsTime, out.width= '80%', fig.align='center', fig.cap= 'Average genetic similarity by standard deviation of the average running day for CGF clusters. Low average distance indicates high genetic similarity, with 0 indicating identical genetic similarity. Low standard deviation of time indicates a smaller window of time that  '}
simvstime <- read.csv("data/distance_dayst.csv", header = TRUE)
...
Financial support for this work was provided through Genome Alberta's Applied Agricultural Genomics Program and the Canadian Wildlife Health Co-operative. 

We would also like thank Dillon Barker for bioinformatics support during this project.
